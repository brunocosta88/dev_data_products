...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
           ...
           p("\n"),
           em("Choose one output varible:"),
           p("\n"),
           selectInput("output_var","Output Varible", choices = variables),
           em("Choose one input varible (for x axis):"),
           p("\n"),
           selectInput("input_var1","Input (x axis)", choices = variables, selected = "wt"),
           em("Choose one or more input varible(s):"),
           p("\n"),
